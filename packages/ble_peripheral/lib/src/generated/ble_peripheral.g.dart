...
class BlePeripheralChannel {
  ...
  Future<void> startAdvertising(List<String?> services, String? localName, int? timeout, ManufacturerData? manufacturerData, bool addManufacturerDataInScanResponse, ManufacturerData? scanResponseManufacturerData) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[services, localName, timeout, manufacturerData, addManufacturerDataInScanResponse, scanResponseManufacturerData]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
