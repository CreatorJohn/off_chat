...
protocol BlePeripheralChannel {
  ...
  func startAdvertising(services: [String], localName: String?, timeout: Int64?, manufacturerData: ManufacturerData?, addManufacturerDataInScanResponse: Bool, scanResponseManufacturerData: ManufacturerData?) throws
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: BlePeripheralChannel?) {
    ...
    if let api = api {
      startAdvertisingChannel.setMessageHandler { message, reply in
        ...
        let scanResponseManufacturerDataArg: ManufacturerData? = nilOrValue(args[5])
        do {
          try api.startAdvertising(services: servicesArg, localName: localNameArg, timeout: timeoutArg, manufacturerData: manufacturerDataArg, addManufacturerDataInScanResponse: addManufacturerDataInScanResponseArg, scanResponseManufacturerData: scanResponseManufacturerDataArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
...
protocol BleCallbackProtocol {
  ...
  func onCharacteristicSubscriptionChange(deviceId deviceIdArg: String, characteristicId characteristicIdArg: String, isSubscribed isSubscribedArg: Bool, name nameArg: String?, completion: @escaping (Result<Void, FlutterError>) -> Void)
