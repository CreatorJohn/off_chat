...
import 'pigeon/ble_peripheral_pigeon.dart';
import 'package:flutter/foundation.dart';
export 'models/ble_enums.dart';
export 'generated/ble_peripheral.g.dart';
...
class BlePeripheral {
  ...
  static Future<void> startAdvertising({
    ...
    ManufacturerData? scanResponseManufacturerData,
  }) {
    return _platform.startAdvertising(
      ...
      scanResponseManufacturerData: scanResponseManufacturerData,
    );
  }
